...
public class SceneController {
    ...
    public ResponseEntity<SceneDTO> createScene(@PathVariable Long sequenceId, @RequestBody CreateSceneDTO createSceneDTO) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SceneDTO> updateScene(@PathVariable Long id, @RequestBody CreateSceneDTO updateSceneDTO) {
        try {
